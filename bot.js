...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['BY|X SHOP','Type !help'];
    var i = -1;
    var j = 0;
...
${prefix}mute @user <time> / اعطاء العضو ميوت تم تعديل mute الى اسكت 
${prefix}unmute @user / لفك الميوت عن الشخص تم تعديل unmute  الى اتكلم
${prefix}kick @user <reason> / طرد الشخص من السيرفر تم تعديل kick الى طرد
${prefix}ban @user <reason> / حضر الشخص من السيرفر تم تعديل ban الى برا
